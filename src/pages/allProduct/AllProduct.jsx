...
//                             selectedSubCategory === subCat ? "bg-blue-200" : "hover:bg-gray-100"
//                           }`}
...
//         <button
//           className="lg:hidden fixed top-20 left-4 z-20 bg-blue-500 text-white px-4 py-2 rounded-md shadow-lg"
...
//         {/* Sidebar Filters */}
//         <aside className={`w-3/4 sm:w-1/2 lg:w-1/4 p-4 border-r bg-white fixed top-0 left-0 h-full z-30 transform ${isMobileFilterOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 transition-transform duration-300 ease-in-out lg:relative lg:block`}>          
//           <div className="flex justify-between items-center mb-4 lg:hidden">
//             <h2 className="text-xl font-semibold">Filters</h2>
//             <X className="cursor-pointer" onClick={closeMobileFilter} />
//           </div>

//           <h2 className="text-xl font-semibold mb-4 hidden lg:block">Filters</h2>
