...
//                                 })
//                             }} name="description" placeholder="Product Description" rows="5" className='bg-slate-50 border text-zinc-700 border-zinc-300 px-2 py-2 w-96 rounded-md outline-none placeholder-slate-400'
//                         >
